...
public class MessageListener {
	...
	public void createSuggestion(String data) {
		...
		estadisticas.enviarAConsolaAdmin("[CREAR SUGERENCIA] Autor de la accion [id=" + sugg.getCitizen().getId() + "] "
				+ sugg.getCitizen().getNombre() + "  [id=" + sugg.getId() + "] " + sugg.getTitulo());
		logger.info("[CREAR SUGERENCIA] Autor de la accion [id=" + sugg.getCitizen().getId() + "] "
				+ sugg.getCitizen().getNombre() + "  [id=" + sugg.getId() + "] " + sugg.getTitulo());
	}
	...
	public void deleteSuggestion(String data) {
		...
		estadisticas.enviarAConsolaAdmin("[ELIMINAR SUGERENCIA] Autor de la accion [id=" + sugg.getCitizen().getId()
				+ "] " + sugg.getCitizen().getNombre() + "  [id=" + sugg.getId() + "] " + sugg.getTitulo());

		logger.info("[ELIMINAR SUGERENCIA] Autor de la accion [id=" + sugg.getCitizen().getId() + "] "
				+ sugg.getCitizen().getNombre() + "  [id=" + sugg.getId() + "] " + sugg.getTitulo());
	}
	...
	public void voteSuggestion(String data) {
		...
		estadisticas
				.enviarAConsolaAdmin("[VOTAR SUGERENCIA] Autor de la accion [id=" + voto.getCitizen().getId() + "] " +

						voto.getCitizen().getNombre() + " en sugerencia: [id=" + voto.getSugerencia().getId() + "]"
						+ voto.getSugerencia().getTitulo());
	...
	public void commentSuggestion(String data) {
		...
		estadisticas.enviarAConsolaAdmin("[COMENTARS SUGERENCIA] Autor del comentario [id="
				+ comentario.getCitizen().getId() + "] " + comentario.getCitizen().getNombre() + " en la sugerencia: "
				+ comentario.getSugerencia().getTitulo());

		logger.info("[COMENTARS SUGERENCIA] Autor del comentario [id=" + comentario.getCitizen().getId() + "] "
				+ comentario.getCitizen().getNombre() + " en la sugerencia: [id=" + comentario.getSugerencia().getId()
				+ "]" + comentario.getSugerencia().getTitulo());
	}
	...
	// "\"");
	//
	// logger.info("[ELIMINAR COMENTARIO] Autor del comentario [id="+
	// comentario.getCitizen().getId()+"] " +
	// comentario.getCitizen().getNombre()+ " en la sugerencia: " +
	// comentario.getSugerencia());
	// }
	...
	public void voteComment(String data) {
		...
		estadisticas.enviarAConsolaAdmin("[VOTO COMENTARIO] Autor de la accion [id="
				+ votoComentario.getCitizen().getId() + "] " + votoComentario.getCitizen().getNombre()
				+ " en el comentario: " + votoComentario.getComentario());
